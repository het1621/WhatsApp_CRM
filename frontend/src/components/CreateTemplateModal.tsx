          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                required
              />
              <p className="text-xs text-gray-500 mt-1">Lowercase, numbers, and underscores only.</p>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white/50 focus:bg-white focus:ring-2 focus:ring-indigo-400 outline-none transition-all resize-none"
                placeholder="Hi {{name}}, your order is ready!"
                required
              />
              <p className="text-xs text-gray-500 mt-1">
                Use <code className="bg-gray-100 px-1 py-0.5 rounded text-indigo-600 font-mono">{"{{variable}}"}</code> to insert dynamic data.
              </p>
            </div>
